  ...
  <div>
    <section class="homepageContent" id="contentWrapper">
      <div class="mainSearch" id="searchWrap">
        <h1 class="mainTitle" id="quickSearchMainTitle">
          Locate Your Perfect Home
        </h1>
    ...
    <section class="property-featured" id="property-featured" v-else>
      ...
      <div id="properties-container">
        <div
          ...
          class="property-placard"
          v-on:mouseover="property.hover = true"
          @mouseleave="property.hover = false"
        >
          <img
            v-bind:src="property.imageUrl"
            alt="Property Image"
            class="property-placard-image"
          />
